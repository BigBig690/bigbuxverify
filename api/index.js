...
const PUBLIC_URL = (
  ...
  process.env.BIGBUX_SITE_URL ||
  process.env.NEXT_PUBLIC_SITE_URL ||
  FALLBACK_URL
).replace(/\/$/, '');

const CLIENT_ID = process.env.DISCORD_CLIENT_ID || '';
const CLIENT_SECRET = process.env.DISCORD_CLIENT_SECRET || process.env.DISCORD_OAUTH_CLIENT_SECRET || '';
...
const VERIFIED_ROLE_ID = process.env.DISCORD_VERIFIED_ROLE_ID || process.env.VERIFIED_ROLE_ID || process.env.VERIFY_ROLE_ID || '';
